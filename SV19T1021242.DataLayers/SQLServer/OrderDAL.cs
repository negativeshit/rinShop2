...
";
        ...
        public bool SaveProvinceAndAddress(int orderID, string deliveryProvince, string deliveryAddress)
        {
            bool result = false;
            using (var connection = OpenConnection())
            {
                var sql = @"if  exists(select * from Orders
                                ...
                                insert into Orders(OrderID, DeliveryProvince, DeliveryAddress)
                                values(@OrderID, @deliveryProvince, @deliveryAddress)
";
                var parameters = new
                {
                    OrderID = orderID,
